...
const unsigned char Rcon1[10] = {0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36};
...
void encrypt2(unsigned char PlainText_16[16], unsigned char Key_16[16], unsigned char CipherText_16[16]) {
    ...
    for (i=1; i<11; i++) {
        ...
        // sBox applied
        TempKeyCol[0]=Sbox1[ TempKeyCol[0] ];
        TempKeyCol[1]=Sbox1[ TempKeyCol[1] ];
        TempKeyCol[2]=Sbox1[ TempKeyCol[2] ];
        TempKeyCol[3]=Sbox1[ TempKeyCol[3] ];
    ...
    for(r=1; r<=10; r++) {
        ...
        for(i=0; i<4; i++)
            for(j=0; j<4; j++)
                StateArray[i][j] = Sbox1[StateArray[i][j]];
